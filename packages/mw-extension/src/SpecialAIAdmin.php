...
class SpecialAIAdmin extends SpecialPage
{
  ...
  private function getAdminI18nMessages(): array
  {
    $keys = [
      ...
      'aiadmin-action-add-namespace-override',
      ...
      'aiadmin-chunking-source-attachment-metadata',
      'aiadmin-chunking-source-attachment-text',
      'aiadmin-chunking-source-cmdb-dynamic-snapshot',
      'aiadmin-chunking-source-defaults',
      'aiadmin-chunking-source-wiki-page',
      ...
      'aiadmin-field-conflict-attachment-parent-mode',
      'aiadmin-field-conflict-show-block',
      'aiadmin-field-conflict-system-prompt',
      'aiadmin-field-conflict-system-prompt-override',
      ...
      'aiadmin-field-oidc-group-mapping-mode',
      'aiadmin-field-oidc-group-mappings',
      'aiadmin-field-oidc-group-preview',
      ...
      'aiadmin-field-answer-system-prompt-override',
      ...
      'aiadmin-help-answer-system-prompt-override',
      'aiadmin-help-conflict-system-prompt-override',
      ...
      'aiadmin-help-namespace-chunking-overrides',
      'aiadmin-help-source-aware-chunking',
      ...
      'aiadmin-reindex-chunk-source-counts',
      ...
      'aiadmin-section-external-group-mapping',
      'aiadmin-section-hybrid-search',
      'aiadmin-section-lexical-experimental',
      'aiadmin-section-namespace-chunking-overrides',
      ...
      'aiadmin-section-source-aware-chunking',
      ...
      'aiadmin-value-attachment-parent-conflict-always',
      'aiadmin-value-attachment-parent-conflict-disabled',
      'aiadmin-value-attachment-parent-conflict-risk-only',
      ...
      'aiadmin-value-group-mapping-mapped-only',
      'aiadmin-value-group-mapping-passthrough',
